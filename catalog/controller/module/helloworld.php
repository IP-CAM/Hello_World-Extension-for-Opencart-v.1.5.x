	...
	class ControllerModuleHelloworld extends Controller
	{
		public function index()
		{
			...
			$this->data['text_success'] = $this->language->get('text_success');
						...
						$temp_hello_world_all=$this->model_catalog_helloworld->getHelloWorldsAll();
						$temp_hello_world = $this->model_catalog_helloworld->helloworld();
						$temp_hello_world_new = $this->model_catalog_helloworld->helloworld();
